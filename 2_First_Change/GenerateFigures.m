...
for ii=1:n
    ...
    xlim([2019+.5/12 2021+5.5/12])
    xticks([2019+.5/12 2020+.5/12 2021+.5/12])
    xticklabels({'Jan 2019','Jan 2020','Jan 2021'})
...
for ii=1:n
    ...
    if ii~=1
        subplot(7,1,count); plot([2020+6.5/12:1/12:2021+4.5/12],realization,...
            'k+','LineWidth',1.5) 
        ylim([60 140])
    end
...
%saveas(f32, 'C:\Users\Javier\Dropbox\Aplicaciones\Overleaf\Econ722-Term-Paper\change_1_figure_32.png');
close(figure(32))
%saveas(f31, 'C:\Users\Javier\Dropbox\Aplicaciones\Overleaf\Econ722-Term-Paper\change_1_figure_31.png');
close(figure(31))
...
%saveas(f42, 'C:\Users\Javier\Dropbox\Aplicaciones\Overleaf\Econ722-Term-Paper\change_1_figure_42.png');
close(figure(42))
%saveas(f41, 'C:\Users\Javier\Dropbox\Aplicaciones\Overleaf\Econ722-Term-Paper\change_1_figure_41.png');
close(figure(41))