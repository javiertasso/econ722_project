...
elseif length(aux)>=3
    eta0=[aux(1:4)'];             % volatility hyperparameters 
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[~,xh,~,~,itct,~,~] = csminwel('logMLVAR_formin_covid',x0,H0,...
    [],1e-16,1000,y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,...
...
[fh,r.postmax.betahat,r.postmax.sigmahat]=logMLVAR_formin_covid(xh,y,x,lags,...
    T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,hyperpriors,priorcoef,Tcovid);
...
%     HH=V*abs(E)*V';
    ...
    fun = @(par) logMLVAR_formcmc_covid(par,y,x,lags,T,n,b,MIN,MAX,SS,...
        Vc,pos,mn,sur,noc,y0,0,hyperpriors,priorcoef,Tcovid);
    ...
    while logMLold==-10e15
        ...
        [logMLold,~,~]=logMLVAR_formcmc_covid(P(1,:)',y,x,lags,T,n,b,...
            MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,...
        ...
        if logMLnew>logMLold
            ...
            if rand(1)<exp(logMLnew-logMLold)
                ...
                if MCMCfcast==1 || MCMCstorecoeff==1
                    [~,betadrawnew,sigmadrawnew]=logMLVAR_formcmc_covid(P(i,:)',y,x,lags,T,n,b,MIN,MAX,SS,Vc,pos,mn,sur,noc,y0,...
                        max([MCMCfcast,MCMCstorecoeff]),hyperpriors,priorcoef,Tcovid);
                end
            end
        end
